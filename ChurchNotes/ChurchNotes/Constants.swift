...
struct K{
    struct Colors{
        ...
        static var lightGray = "lightGray"
        static var justLightGray = "justLightGray"
        static var gray = "gray"
        static var darkGray = "darkGray"
        static var justDarkGray = "justDarkGray"
        static var background = "background"
        static var bluePurple = "blue-purple"
        static var lightGreen = "lightGreen"
        static var orange = "orange"
        static var pink = "pink"
        static var lightBlue = "lightBlue"
    }
    struct Countries{
